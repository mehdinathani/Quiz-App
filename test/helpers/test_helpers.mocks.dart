...
class MockStudentsDataServiceService extends _i1.Mock
  ...
  @override
  _i5.Future<void> submitExamResult(
    String? rollNumber,
    String? name,
    String? fathersName,
    String? group,
  ...
  @override
  _i5.Future<Map<String, String>> getStudentExamData(String? rollNumber) =>
      (super.noSuchMethod(
        Invocation.method(
          #getStudentExamData,
          [rollNumber],
  ...
  @override
  _i5.Future<void> recordAttendance({
...
class MockQuizDataServiceService extends _i1.Mock
  ...
  @override
  _i5.Future<List<Map<String, String>>?> fetchAllQuizData() =>
      (super.noSuchMethod(
        Invocation.method(
          #fetchAllQuizData,
          [],
  ...
  @override
  _i5.Future<void> updateEarnedPoints(
    String? questionId,
    int? earnedPoints,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Future<void> resetEarnedPoints() => (super.noSuchMethod(
        Invocation.method(
          #resetEarnedPoints,
          [],
        ),
...
class MockFirebaseAuthService extends _i1.Mock
  ...
  @override
  String get loginMessage => (super.noSuchMethod(
        Invocation.getter(#loginMessage),
        returnValue: _i3.dummyValue<String>(
          this,
          Invocation.getter(#loginMessage),
        ),
  ...
  @override
  set loginMessage(String? _loginMessage) => super.noSuchMethod(
        Invocation.setter(
          #loginMessage,
          _loginMessage,
        ),
  ...
  @override
  _i5.Stream<_i11.User?> get onAuthStateChanged => (super.noSuchMethod(
  ...
  @override
  _i5.Future<void> signInWithEmail(
    String? emailAddress,
    String? password,
  ) =>
      (super.noSuchMethod(
